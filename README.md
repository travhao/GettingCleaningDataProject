...
# Code Book below comes from the README file in the Zipped Dataset
...
NOTE:  the info below was provided with the dataset.  However, I've modified and updated to only include the variables 
I used as well as the title designations I use (used "." instead of parentheses "()")
